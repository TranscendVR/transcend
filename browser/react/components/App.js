    ...
    <div style={{ width: '100%', height: '100%' }}>
      <a-scene id="scene" scene-load>
        ...
        <a-entity position="-10 1 -1">
          <a-entity class='clickable' geometry="primitive: sphere" rotation="0 200 0" radius="0.3" material="color: #EF2D5E" opacity="1" roughness="0.8" href="sean"></a-entity>
        ...
        <a-entity position="-10 1 1">
          <a-entity class='clickable' geometry="primitive: sphere" rotation="0 200 0" radius="0.3" material="color: yellow" opacity="1" roughness="0.8" href="beth"></a-entity>
          <a-entity geometry="primitive: sphere" class="highlight" visible="false" radius="0.35" rotation="0 0 0" color="#0000ff" opacity="0.6" roughness="1" metalness="0.5"></a-entity>
          <a-entity geometry="primitive: box;" id="shadow" position="0 -1 0" color="#000" opacity="1" rotation="0 0 0" scale="0.4 1 0.4"></a-entity>
        </a-entity>
        <a-entity position="-10 1 3">
          <a-entity class='clickable' geometry="primitive: sphere" rotation="0 200 0" radius="0.3" material="color: blue" opacity="1" roughness="0.8" href="joey"></a-entity>
          <a-entity geometry="primitive: sphere" class="highlight" visible="false" radius="0.35" rotation="0 0 0" color="#0000ff" opacity="0.6" roughness="1" metalness="0.5"></a-entity>
          <a-entity geometry="primitive: box;" id="shadow" position="0 -1 0" color="#000" opacity="1" rotation="0 0 0" scale="0.4 1 0.4"></a-entity>
        </a-entity>
        <a-entity position="-10 1 5">
          <a-entity class='clickable' geometry="primitive: sphere" rotation="0 200 0" radius="0.3" material="color: green" opacity="1" roughness="0.8" href="yoonah"></a-entity>
          <a-entity geometry="primitive: sphere" class="highlight" visible="false" radius="0.35" rotation="0 0 0" color="#0000ff" opacity="0.6" roughness="1" metalness="0.5"></a-entity>
          <a-entity geometry="primitive: box;" id="shadow" position="0 -1 0" color="#000" opacity="1" rotation="0 0 0" scale="0.4 1 0.4"></a-entity>
        </a-entity>
      </a-scene>
