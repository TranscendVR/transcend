...
THREEx.MinecraftChar = function (skinUrl) {
  ...
  group.position.y = sizes.charH - sizes.headH - 0.9;
  ...
  model.body.position.y = sizes.legH + sizes.bodyH / 2 - 0.9;
  ...
  model.armR.position.y = sizes.legH + sizes.bodyH - sizes.armW / 2 - 0.9;
  ...
  model.armL.position.y = sizes.legH + sizes.bodyH - sizes.armW / 2 - 0.9;
  ...
  model.legR.position.y = sizes.legH - 0.9;
  ...
  model.legL.position.y = sizes.legH - 0.9;
